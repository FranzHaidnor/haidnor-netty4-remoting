...
public class ByteBufferUtil {
     ...
     */
    public static void logAll(ByteBuffer buffer) {
     ...
     */
    public static void logAll(ByteBuf byteBuf) {
        logAll(byteBuf.nioBuffer());
    }
     ...
     * @param buffer ByteBuffer
     */
    public static void logRead(ByteBuffer buffer) {
     ...
     */
    public static void logRead(ByteBuf byteBuf) {
        logRead(byteBuf.nioBuffer());
    }
